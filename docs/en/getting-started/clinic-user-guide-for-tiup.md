---
sidebar_position: 3
title: Use PingCAP Clinic For TiUP Environment
...
# Clinic Diagnostic Service Operation Manual for TiUP Environment
...
2. Get and set an access token (token) to upload data.
    ...
    ![Get the Token](/img/getting-started/get-token.png)
